  ...
  <script>
      function prepararDados(AtendimentoId, Nome, Data, Tipo, Descricao, Atendidopor, Status) {
          document.getElementById('modal-editar-produto-AtendimentoId').value = AtendimentoId;
